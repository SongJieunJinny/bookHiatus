...
## 📌개요
- 온라인 독립서점 웹서비스로, 회원·비회원 주문/결제, 도서 검색·상세·장바구니, 게시판(공지/Q&A/이벤트) 등 커머스 핵심 흐름을 end-to-end로 구현.
...
- 회원은 주문내역 조회·영수증 확인, 배송 전 취소·배송 후 환불 신청과 진행상태 추적이 가능하며, 장바구니 로컬↔DB 자동동기화, 리뷰/좋아요, Kakao 로그인 지원.
